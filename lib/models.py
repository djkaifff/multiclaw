...
CLI_PROVIDERS = {
    "claude-cli": {
        ...
        "cli_bin": "claude",
        "models": [
            {"id": "claude-opus-4-7",   "name": "Claude Opus 4.7",   "tags": "thinking · powerful · latest"},
            {"id": "claude-opus-4-6",   "name": "Claude Opus 4.6",   "tags": "thinking · powerful"},
            {"id": "claude-opus-4-5",   "name": "Claude Opus 4.5",   "tags": "thinking · powerful"},
            {"id": "claude-sonnet-4-6", "name": "Claude Sonnet 4.6", "tags": "thinking · fast"},
            {"id": "claude-sonnet-4-5", "name": "Claude Sonnet 4.5", "tags": "fast · balanced"},
            {"id": "claude-haiku-4-5",  "name": "Claude Haiku 4.5",  "tags": "fast · cheap"},
        ],
    },
    "codex-cli": {
    ...
    "gemini-cli": {
        ...
        "cli_bin": "gemini",
        "models": [
            {"id": "gemini-2.5-pro",        "name": "Gemini 2.5 Pro",        "tags": "powerful · latest"},
            {"id": "gemini-2.5-flash",       "name": "Gemini 2.5 Flash",      "tags": "fast · balanced"},
            {"id": "gemini-2.5-flash-lite",  "name": "Gemini 2.5 Flash Lite", "tags": "fast · cheap"},
            {"id": "gemini-2.0-flash",       "name": "Gemini 2.0 Flash",      "tags": "fast"},
            {"id": "gemini-2.0-pro-exp",     "name": "Gemini 2.0 Pro (exp)",  "tags": "powerful · experimental"},
            {"id": "gemini-1.5-pro",         "name": "Gemini 1.5 Pro",        "tags": "powerful"},
            {"id": "gemini-1.5-flash",       "name": "Gemini 1.5 Flash",      "tags": "fast · cheap"},
        ],
    },
